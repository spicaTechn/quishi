    ...
    <script type="text/javascript" src="{{ asset('/admin_assets/bower_components/popper.js/js/popper.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/admin_assets/bower_components/bootstrap/js/bootstrap.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('/admin_assets/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js') }}"></script>
